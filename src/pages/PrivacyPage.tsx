    ...
    <main className="subpage privacy-policy-page">
      ...
      <header className="policy-hero">
        <div className="shell policy-hero__grid">
          <div className="policy-hero__copy">
            ...
            <div className="policy-meta"><span><small>Effective</small><strong>12 August 2026</strong></span><span><small>Applies to</small><strong>Peeky 1.2.0</strong></span><span><small>Policy version</small><strong>1.0</strong></span></div>
          </div>
      ...
      <div className="shell policy-layout">
        <aside className="policy-toc" aria-label="Policy contents">
          ...
          <div className="policy-toc__status"><ShieldCheck size={16} /><span><strong>Local-first release</strong><small>Peeky 1.2.0</small></span></div>
        </aside>
        ...
        <article className="policy-document">
          ...
          <section id="changes">
            ...
            <p>If Peeky’s data practices change, this page should be updated with a new effective date and policy version. A future feature that sends data off-device would require an explicit revision to this policy; it is not part of Peeky 1.2.0.</p>
          </section>
        </article>
      </div>

      <section className="policy-download"><div className="shell"><div><AppMark size="medium" /><span><strong>Ready for calmer screen time?</strong><small>Windows 10/11 · No account required</small></span></div><a className="button button--dark" href="/download/">Download Peeky</a></div></section>
      <SiteFooter />
    </main>
  );
}

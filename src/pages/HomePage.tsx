        ...
        <div className="shell hero-grid">
          <div className="hero-copy">
            ...
            <div className="download-note">
              ...
              <span><Check size={14} /> v2.1.1</span>
            </div>
          </div>
      ...
      <section className="download-cta" id="download" data-reveal>
        <div className="shell download-cta__inner">
          ...
          <div className="hero-actions hero-actions--center">
            <a className="button button--dark button--large" href="/downloads/Peeky-Setup-x64.exe" download><Download size={19} /> Download Peeky v2.1.1</a>
